...
for n=1:Nbr_obstacle
	...
	for l=1:3
		for i=1:2
			...
			@constraint(m,gain*aux1[n,l,i]>=0)
		    @constraint(m,gain*aux1[n,l,i]>=-gain*M_obs[n,l,valeur])
		    @constraint(m,gain*aux1[n,l,i]>=gain*M_obs[n,l,valeur])
		end
	end
	for l=1:3
		@constraint(m,(M_obs[n,l,l])>=aux1[n,l,1]+aux1[n,l,2])
	end
end
...
for l=1:8
	for i=1:7
		...
		@constraint(m,gain*aux2[l,i]>=0)
		@constraint(m,gain*aux2[l,i]>=-gain*M[l,valeur])
		@constraint(m,gain*aux2[l,i]>=gain*M[l,valeur])
	end
end
for l=1:8
	@constraint(m,(M[l,l])>=aux2[l,1]+aux2[l,2]+aux2[l,3]+aux2[l,4]+aux2[l,5]+aux2[l,6]+aux2[l,7])
end
